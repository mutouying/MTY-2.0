/* -------------------------------------------------------------------------
// 文件名      :	easyipc/EasyIpcMTLibClientWrap.h
// 创建人      :	dingping
...
// $Id: $
// -----------------------------------------------------------------------*/
#ifndef __EASYIPC_EASYIPCMTLIBCLIENTWRAP_H__
#define __EASYIPC_EASYIPCMTLIBCLIENTWRAP_H__

#include "easyipclibcommonwrap.h"
#pragma comment(lib, "keasyipc_lib_ksapi_mt.lib")
...
#endif /* __EASYIPC_EASYIPCMTLIBCLIENTWRAP_H__ */
