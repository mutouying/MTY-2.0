/* -------------------------------------------------------------------------
// 文件名      :	easyipc/EasyIpcServerWrap.h
// 创建人      :	dingping
...
/////////////////////////////////////////
#define EASYIPC_REGISTER_METHODEx(pszInterface, class, method, obj)                        \
    int s_n##pszInterface##method = KEasyIpcServerWrap::Instance().Register(               \
    pszInterface, L#method, EasyIpcExecWrap<class>::CreateObj((obj), &class::method)); 
...
#define EASYIPC_UNREGISTEREx(class)          KEasyIpcServerWrap::Instance().Unregister(class)
